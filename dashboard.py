...
with st.sidebar:
    ...
    selected_station = st.sidebar.selectbox("Select Station", ["All", "Aotizhongxin", "Changping", "Dingling", "Dongsi","Guanyuan","Gucheng","Huairou","Nongzhanguan","Shunyi","Tiantan","Wanliu","Wanshouxigong"])


@st.cache_data
def load_data():
    df = pd.read_csv("gabungan_df.csv") 
    return df
...
data = pd.read_csv("gabungan_df.csv")
